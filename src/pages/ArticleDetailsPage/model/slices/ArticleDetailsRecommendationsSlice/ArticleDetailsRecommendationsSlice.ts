...
} from '../../services/fetchRecommendationsForArtilce/fetchRecommendationsForArtilce';
...
export const articleDetailsRecommendationsSlice = createSlice({
    ...
    extraReducers: (builder) => {
        builder
            ...
            .addCase(fetchRecommendationsForArtilce.fulfilled, (
                state,
            ...
            .addCase(fetchRecommendationsForArtilce.rejected, (state, action) => {
                state.isLoading = false;
